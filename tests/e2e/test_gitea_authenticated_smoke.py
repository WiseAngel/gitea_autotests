...
@qase.id(21)
@allure.title("Authenticated user lands on their personal dashboard")
...
@qase.id(22)
@allure.title("Authenticated user can open the settings page")
@allure.severity(allure.severity_level.CRITICAL)
...
@qase.id(23)
@allure.title("Authenticated user can see their repository list")
@allure.severity(allure.severity_level.CRITICAL)
...
@qase.id(24)
@allure.title("Authenticated user's public profile page renders correctly")
@allure.severity(allure.severity_level.CRITICAL)
